define('JSComposer/Instance/ObjectInstance', ['JSComposer/Utils', 'JSComposer/Instance'], function(Utils, Instance) {
    ...
    function ObjectInstance(context, parent, schema, value) {
        ...
        // UI Components
        this.elements.body  = Utils.makeElement('div', {'className':'object body'});
        if (typeof this.title !== 'undefined') {
            this.elements.header = Utils.makeElement('h3', {'className':'object header'});
    ...
    ObjectInstance.prototype.AddSection = function(type, properties, value) {
        ...
        var options = ObjectInstance.PropertyOptions[type],
            ctr     = Utils.makeElement('div', {'className':'object section'});
            header  = Utils.makeElement('h4', {'className':'object section header'}),
            content = Utils.makeElement('div', {'className':'object section content'}),
            footer  = Utils.makeElement('div', {'className':'object section footer'}),
            more    = undefined;

        Utils.setText(header, options.header);
    ...
    ObjectInstance.prototype.AddEntry = function(type, key_desc, value_desc, key, value) {
        var self        = this,
            ...
            ctr         = Utils.makeElement('div', {'className':'entry'});
    ...
    ObjectInstance.prototype.OnAddEntry = function(type) {
        ...
        console.log('[ObjectInstance]', 'Adding Entry', key_schema, val_schema);
