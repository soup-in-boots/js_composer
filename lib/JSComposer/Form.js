define('JSComposer/Form', ['JSComposer/Utils', 'JSComposer/Instance'], function(Utils, Instance) {
    function Form(schema, value) {
        ...
        this.elements = {
            'form':         Utils.makeElement('form', {'name': this.formID, 'id': this.formID, 'method':'POST'}),
            'body':         Utils.makeElement('div', {'className':'form body'}),
            'footer':       Utils.makeElement('div', {'className':'form footer'}),
            'submit':       Utils.makeElement('div', {'className':'submit button'})
        };
