define('JSComposer/Instance', ['JSComposer/Utils', 'JSComposer/Schema', 'EventEmitter'], function(Utils, Schema, EventEmitter) {
    // Constructor
    function Instance(context, parent, type_desc, value) {
        ...
        this.parent = parent;
        this.elements = {
            ctr:        Utils.makeElement("div", {"className":""})
        };
        schema = Utils.ldef(type_desc, {'type':'null'});

        console.log("[Instance] Built myself:", this);
        ...
        Object.defineProperty(this, 'value', {
            ...
            set: function(newValue) {
                console.log("[Instance] Acquired new value:", newValue);
                $self.emit('change', newValue, this._value);
